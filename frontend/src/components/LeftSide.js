    ...
    return (
        <div className='leftside'>
           ...
           { show?null:(<div className="sidebar-msg">
                <div className="img">
                    <img src="https://cdn.dribbble.com/userupload/11248763/file/original-4da5101cd12c035da322d6d932d4d243.png?resize=450x338&vertical=center"  alt="" />
                </div>
                <div className="text">
                    <h2>Fast Delivery <span>@</span> your door.</h2>
                </div>
            </div>)}
