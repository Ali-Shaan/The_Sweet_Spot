...
const Cart = () => {
    ...
    const deleviryPrice = (cartPrice>=2000||cartPrice===0)?0:250
    const discount = 0;
                  ...
                  <div className='cart-area'>
                      ...
                      <div className="billing">
                        ...
                        <div className="details">
                            <div className="item">
                                <p>Price</p>
                                <p><span>Rs.</span>{cartPrice}</p>
                            </div>
                           
                            <div className="item">
                                <p>Delivery Charges</p>
                                <p>{deleviryPrice===0?<span className='free'>Free</span>:<span>Rs.{deleviryPrice}</span>}</p>
                            </div>
                        </div>
                        <div className="total">
                            <h3>Total</h3>
                            <h3><span>Rs.</span>{totalPrice}</h3>
                        </div>
                      </div>
