                  ...
                  <div className="all-items">
                     {orderItems?.map((item)=>(
                         ...
                         <div className="des">
                            <h3>{item.name}</h3>
                            <p>qty:{item.qty}</p>
                            <p className='des'>{item.description?item.description:'Your Order will be Delivered in 30 mins'}</p>
                         </div>
                         <div className="price">
...
<div className="checkout-area">
                   <div className="billing">
                     ...
                     <div className="details">
                         <div className="item">
                             <p>Price</p>
                             <p><span>Rs.</span>{itemsPrice}</p>
                         </div>
                        
                         <div className="item">
                             <p>Delivery Charges</p>
                             <p>{shippingPrice===0?<span className='free'>Free</span>:<span>Rs.{shippingPrice}</span>}</p>
                         </div>
                     </div>
                     <div className="total">
                         <h3>Total</h3>
                         <h3><span>Rs.</span>{totalprice?.toFixed(2)}</h3>
                     </div>
                   </div>
     </div>
</div>):<OrderDetail/>}
